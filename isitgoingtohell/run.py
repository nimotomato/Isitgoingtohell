...
from isitgoingtohell.label_analysis.label_analysis import Dated_methods, Undated_methods
...
from isitgoingtohell.utils import delete_local_file, load_json
...
def upload_label_analysis(label_analysis_data, database_object, dated: bool, label_analysis_object):
    if dated:
        ...
        mogrified_data = database_object.mogrify_data(
            data=presorted_data, number_of_columns=number_of_columns
        )
        # Upload
